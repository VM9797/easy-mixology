...
public interface EasyMixologyConfig extends Config {
  ...
  @ConfigSection(name = "General settings", description = "General behavior settings", position = 0)
  ...
  @ConfigSection(name = "Overlay", description = "Overlay configuration", position = 2)
  ...
  @ConfigItem(
      ...
      description =
          "Display an informative overlay containing a multitude of information related to the minigame",
  ...
  @ConfigSection(name = "Digweed", description = "Digweed outlining configuration", position = 3)
  ...
  @ConfigSection(name = "Levers", description = "Lever outlining configuration", position = 4)
  ...
  @ConfigSection(name = "Vessel", description = "Vessel outlining configuration", position = 5)
  ...
  @ConfigSection(name = "Refinery", description = "Refinery outlining configuration", position = 6)
  ...
  @ConfigItem(
      ...
      name = "Outline",
      description =
          "Toggles to outline the refinery stations or not. Speedup outline has a different toggle!",
  ...
  @ConfigItem(
      ...
      description =
          "Color to use to outline the refinery station when picking up the potion to pre-indicate which station to go to",
      section = refinerySection)
  ...
  @ConfigItem(
      ...
      name = "Refinery speedup outline",
      description =
          "Color to use to outline the agitator or alembic station when speedup action is possible",
      section = refinerySection)
  default Color refinerySpeedupOutline() {
    return new Color(0, 255, 255);
  }

  @ConfigSection(name = "Deposit", description = "Deposit outlining configuration", position = 7)
  ...
  @ConfigItem(
      ...
      description =
          "Switch the left click option on agitator to walk through it when ready to deposit the order (useful when "
              + "facing north)",
