...
public class MixologyStats {
  ...
  @Getter private int hopperMoxCount = 0;

  @Getter private int hopperAgaCount = 0;

  @Getter private int hopperLyeCount = 0;

  @Getter private int playerMoxCount = -1;

  @Getter private int playerAgaCount = -1;

  @Getter private int playerLyeCount = -1;

  @Getter private int sessionMoxCount = 0;

  @Getter private int sessionAgaCount = 0;

  @Getter private int sessionLyeCount = 0;

  @Getter private boolean arePlayerCountsLoaded = false;

  @Getter private int targetMox = 0;

  @Getter private int targetAga = 0;

  @Getter private int targetLye = 0;

  @Getter private int targetMoxPercent = 0;

  @Getter private int targetAgaPercent = 0;

  @Getter private int targetLyePercent = 0;
  ...
  private void updateTargets() {
    ...
    targetMoxPercent =
        Integer.min((int) (100.0 * ((double) playerMoxCount / (double) targetMox)), 100);
    targetAgaPercent =
        Integer.min((int) (100.0 * ((double) playerAgaCount / (double) targetAga)), 100);
    targetLyePercent =
        Integer.min((int) (100.0 * ((double) playerLyeCount / (double) targetLye)), 100);
  }
