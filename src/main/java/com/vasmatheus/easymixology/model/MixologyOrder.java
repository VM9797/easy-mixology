...
public class MixologyOrder {
  public static final MixologyOrder EMPTY =
      new MixologyOrder(
          Potion.NONE,
          Potion.NONE,
          Potion.NONE,
          ...
          RefinementType.NONE,
          60,
          PotionSelectionStrategy.NO_AGA_TRIPLES_UNLESS_MIXALOT);
  ...
  @Getter private int numberOfPotionsToDo = 0;

  private final int playerHerbloreLevel;
  private final PotionSelectionStrategy strategy;

  public MixologyOrder(
      Potion firstPotion,
      Potion secondPotion,
      Potion thirdPotion,
      RefinementType firstPotionRefinement,
      RefinementType secondPotionRefinement,
      RefinementType thirdPotionRefinement,
      int playerHerbloreLevel,
    ...
    boolean hasMixalot =
        firstPotion == Potion.MIXALOT
            || secondPotion == Potion.MIXALOT
            || thirdPotion == Potion.MIXALOT;
    ...
    isValidOrder =
        firstPotion != Potion.NONE
            && secondPotion != Potion.NONE
            && thirdPotion != Potion.NONE
  ...
  public static MixologyOrder fromVarbits(Client client, PotionSelectionStrategy strategy) {
    return new MixologyOrder(
        Potion.fromVarbitValue(client.getVarbitValue(MixologyVarbits.ORDER_FIRST_POTION)),
        ...
        RefinementType.fromVarbitValue(
            client.getVarbitValue(MixologyVarbits.ORDER_FIRST_POTION_REFINEMENT)),
        RefinementType.fromVarbitValue(
            client.getVarbitValue(MixologyVarbits.ORDER_SECOND_POTION_REFINEMENT)),
        RefinementType.fromVarbitValue(
            client.getVarbitValue(MixologyVarbits.ORDER_THIRD_POTION_REFINEMENT)),
