...
public class MixologyVariablesSnapshot {
    ...
    private MixologyVariablesSnapshot(Potion potionInVessel, int agitatorLevel, int retortLevel, int alembicLevel, PotionComponent componentInFirstMixer, PotionComponent componentInSecondMixer, PotionComponent componentInThirdMixer) {
